...
function roundRect(startX, startY, width, height, color, fill, lineWidth) {
...
roundRect(14, 14, canvas.width - 28, canvas.height - 28, "white", false, 8);

roundRect(17, 17, canvas.width - 34, canvas.height - 34, "black", false, 2);
...
roundRect(19, 19, canvas.width - 38, canvas.height - 38, gradient, true);
...
roundRect(125, 65, canvas.width - 250, canvas.height - 130, gradient, true);

roundRect(135, 75, canvas.width - 270, canvas.height - 150, "black", false, 2);
...
roundRect(150, 90, canvas.width - 300, canvas.height - 180, "black", false, 4);

roundRect(148, 88, canvas.width - 296, canvas.height - 176, "white", false, 4);
